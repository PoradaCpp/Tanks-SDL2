...
GamePageInitData::GamePageInitData( Renderer renderer ):
    ...
    ({
     ...
     ({
         ...
         {
            { m_BaltExtB, "HI SCORE:",   m_Red_Hazel, m_Black, 90,  200, 1, 2, { 39.0, 17,   15.2, 5 }, { 1.2, 2.1, 99, 95.4 }},
            { m_BaltExtB, "STAGE",       m_Red_Hazel, m_Black, 120, 255, 1, 2, { 44.1, 25,   10.0, 6 }, { 1.2, 2.1, 99, 95.4 }},
            { m_BaltExtB, "PLAYER 1:",   m_Red_Hazel, m_Black, 125, 255, 1, 2, { 19.5, 25,   12.1, 5 }, { 1.2, 2.1, 99, 95.4 }},
            { m_BaltExtB, "PLAYER 2:",   m_Red_Hazel, m_Black, 125, 255, 1, 2, { 61.9, 25,   12.1, 5 }, { 1.2, 2.1, 99, 95.4 }},
            { m_BaltExtB, "POINTS",      m_Red_Hazel, m_Black, 125, 255, 1, 2, { 38.0, 35.5, 8.8,  5 }, { 1.2, 2.1, 99, 95.4 }},
            { m_BaltExtB, "POINTS",      m_Red_Hazel, m_Black, 125, 255, 1, 2, { 38.0, 46.4, 8.8,  5 }, { 1.2, 2.1, 99, 95.4 }},
            { m_BaltExtB, "POINTS",      m_Red_Hazel, m_Black, 125, 255, 1, 2, { 38.0, 57.3, 8.8,  5 }, { 1.2, 2.1, 99, 95.4 }},
            { m_BaltExtB, "POINTS",      m_Red_Hazel, m_Black, 125, 255, 1, 2, { 38.0, 68.2, 8.8,  5 }, { 1.2, 2.1, 99, 95.4 }},
            { m_BaltExtB, "TOTAL:   20", m_Red_Hazel, m_Black, 125, 255, 1, 2, { 38.3, 77,   13.3, 5 }, { 1.2, 2.1, 99, 95.4 }}
         },
         {
            { m_BaltExtB, "20000",       m_Red_Hazel, m_Black, 90,  200, 1, 2, { 55.0, 17,   8.8,  5 }, { 1.2, 2.1, 99, 95.4 }},
            { m_BaltExtB, "1",           m_Red_Hazel, m_Black, 120, 255, 1, 2, { 56.1, 25,   2.0,  6 }, { 1.2, 2.1, 99, 95.4 }},
            { m_BaltExtB, "0",           m_Red_Hazel, m_Black, 125, 255, 1, 2, { 32.9, 25,   1.6,  5 }, { 1.2, 2.1, 99, 95.4 }},
            { m_BaltExtB, "0",           m_Red_Hazel, m_Black, 125, 255, 1, 2, { 75.3, 25,   1.6,  5 }, { 1.2, 2.1, 99, 95.4 }},
            { m_BaltExtB, "0",           m_Red_Hazel, m_Black, 125, 255, 1, 2, { 35.0, 35.5, 1.6,  5 }, { 1.2, 2.1, 99, 95.4 }},
            { m_BaltExtB, "0",           m_Red_Hazel, m_Black, 125, 255, 1, 2, { 50.0, 35.5, 1.6,  5 }, { 1.2, 2.1, 99, 95.4 }},
            { m_BaltExtB, "0",           m_Red_Hazel, m_Black, 125, 255, 1, 2, { 35.0, 46.4, 1.6,  5 }, { 1.2, 2.1, 99, 95.4 }},
            { m_BaltExtB, "0",           m_Red_Hazel, m_Black, 125, 255, 1, 2, { 50.0, 46.4, 1.6,  5 }, { 1.2, 2.1, 99, 95.4 }},
            { m_BaltExtB, "0",           m_Red_Hazel, m_Black, 125, 255, 1, 2, { 35.0, 57.3, 1.6,  5 }, { 1.2, 2.1, 99, 95.4 }},
            { m_BaltExtB, "0",           m_Red_Hazel, m_Black, 125, 255, 1, 2, { 50.0, 57.3, 1.6,  5 }, { 1.2, 2.1, 99, 95.4 }},
            { m_BaltExtB, "0",           m_Red_Hazel, m_Black, 125, 255, 1, 2, { 35.0, 68.2, 1.6,  5 }, { 1.2, 2.1, 99, 95.4 }},
            { m_BaltExtB, "0",           m_Red_Hazel, m_Black, 125, 255, 1, 2, { 50.0, 68.2, 1.6,  5 }, { 1.2, 2.1, 99, 95.4 }}
         },
